...
vi.mock('../../../src/debug/debug-session-manager.js', () => ({
  DebugSessionManager: vi.fn().mockImplementation(function () {
    return {
...
vi.mock('../../../src/languages/language-handler-manager.js', () => ({
  LanguageHandlerManager: vi.fn().mockImplementation(function () {
    return {
      initialize: vi.fn().mockResolvedValue(undefined),
      getStatistics: vi.fn().mockReturnValue({
        totalHandlers: 2,
...
vi.mock('../../../src/detectors/error-detector-manager.js', () => ({
  ErrorDetectorManager: vi.fn().mockImplementation(function () {
    return {
      initialize: vi.fn().mockResolvedValue(undefined),
