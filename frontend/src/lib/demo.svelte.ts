...
const CONNECTED_DEMO_PROVIDERS = [
  ...
  },
  {
    ...
    selectedModels: ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'],
    allAvailableModels: [
      ['gpt-5.5', 'GPT-5.5'],
      ['gpt-5.4', 'GPT-5.4'],
...
function spawnWorkers(sessionId: string) {
  for (const w of WORKERS) {
    ...
    const usage = w.id === 'w-fe'
      ? { tokensUsed: 84_200, contextWindow: 372_000, breakdown: { system: 8_400, memory: 6_800, tools: 41_100, chat: 27_900 } }
      : w.id === 'w-be'
        ? { tokensUsed: 112_600, contextWindow: 1_000_000, breakdown: { system: 7_900, memory: 9_200, tools: 63_500, chat: 32_000 } }
        : { tokensUsed: 46_800, contextWindow: 1_000_000, breakdown: { system: 6_100, memory: 4_700, tools: 18_600, chat: 17_400 } };
