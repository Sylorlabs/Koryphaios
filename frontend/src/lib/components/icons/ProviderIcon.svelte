...
{:else if provider.toLowerCase() === 'freebuff' || provider.toLowerCase() === 'codebuff'}
  ...
  >
    ...
    <path
      d="M12 4.5c.3 2.2 1.1 3.8 2.4 5.1 1.3 1.3 2.9 2.1 5.1 2.4-2.2.3-3.8 1.1-5.1 2.4-1.3 1.3-2.1 2.9-2.4 5.1-.3-2.2-1.1-3.8-2.4-5.1-1.3-1.3-2.9-2.1-5.1-2.4 2.2-.3 3.8-1.1 5.1-2.4 1.3-1.3 2.1-2.9 2.4-5.1z"
      fill="#fff"
    />
  </svg>
