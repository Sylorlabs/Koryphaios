...
export const PROFESSIONAL_SKILL_DEFINITIONS: SkillDefinition[] = [
  ...
  },
  {
    ...
    excludes: ['voice only'],
    instructions: `Confirm the visual medium, viewing conditions, platform conventions, content, product identity, and access constraints. Begin with a concise visual read: product or page kind, audience, desired character, existing brand/design-system evidence, and the intended variance, motion, and density. Ask one focused question only when plausible directions materially diverge; otherwise state the read and proceed. Reuse existing tokens and components. Establish a purposeful hierarchy and design complete representative states. Reject ornamental gradients, glass, excessive cards, fake metrics, arbitrary shadows, copied premium patterns, and gratuitous motion; verify rendered output across scale, density, localization, contrast, and reduced motion.`,
    should: ['create a strong visual direction'],
    shouldNot: ['design a voice-only flow'],
    evidence: [
      'Visual read and direction rationale',
      'Purposeful visual direction',
      'Rendered state matrix',
      'Scale contrast motion and anti-pattern checks',
    ],
  },
  {
  ...
  },
  {
    ...
    activation: [
      ...
      'embedded display verification',
    ],
    instructions: `Inspect the actual target runtime at representative sizes, content, themes, inputs, and relevant loading, empty, error, disabled, focus or selection, overflow, resize, and interruption states. First apply the universal visual audit: hierarchy, repetition, token consistency, purposeful assets, contrast or equivalent legibility, and motion rationale. Then apply only the confirmed medium's checks; do not force browser responsiveness, pointer hover, screenshots, or DOM semantics onto native, terminal, game, spatial, or embedded interfaces. Mark each checked claim passed, failed, or unavailable; captures are evidence, not a substitute for behavior and semantics.`,
    should: ['visually verify the interface'],
    shouldNot: ['verify a headless parser'],
    evidence: ['Runtime captures', 'State and viewport matrix', 'Visual-direction claim audit'],
  },
  {
