...
For TUIs, define focus, selection, navigation, resize behavior, scroll ownership, shortcuts, screen-reader or plain-text fallback expectations, and recovery after terminal suspension. Never import browser layout or pointer-hover assumptions. Verify real terminal behavior, piping, redirection, errors, cancellation, resizing, and degraded color or Unicode environments.`,
