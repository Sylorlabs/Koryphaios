...
mock.module('../../../providers/auth-utils', () => ({
  ...
  detectKiloCLILogin: () => false,
  createKiloCLIAuthMarker: () => 'cli:kilo:test',
  isKiloCLIAuthMarker: (value: string | null | undefined) => value === 'cli:kilo:test',
  discoverFreebuffAccounts: () => [],
  readFreebuffCredentialsFrom: () => null,
  clearCachedToken: () => {},
  clearTokenCache: () => {},
