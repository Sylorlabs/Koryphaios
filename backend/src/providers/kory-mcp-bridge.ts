...
const KORY_TOOLS: KoryToolDef[] = [
  ...
  // ── Interaction ──
  {
    name: 'kory__ask_user',
    description:
      'Ask a focused question with suggested choices. The UI adds Custom response and Keep chatting. Add sliders or one bar, line, or pie chart only when they materially help the decision.',
    inputSchema: {
      type: 'object',
      properties: {
