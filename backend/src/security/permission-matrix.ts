...
export const DEFAULT_PERMISSION_MATRIX: PermissionMatrix = {
  ...
  tools: {
    ...
    get_note_properties: { tool: 'get_note_properties', level: 'auto' },
    query_note_base: { tool: 'query_note_base', level: 'auto' },
    record_work_note: { tool: 'record_work_note', level: 'ask' },
    create_note: { tool: 'create_note', level: 'ask' },
    set_note_property: { tool: 'set_note_property', level: 'ask' },
